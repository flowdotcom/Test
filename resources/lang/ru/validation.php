...
return [
    ...
    'active_url'           => 'Поле :attribute содержит недействительный адрес URL.',
    'after'                => 'В поле :attribute должна быть дата после :date.',
    'after_or_equal'       => 'В поле :attribute должна быть дата после и такая же как :date.',
    ...
    'before_or_equal'      => 'В поле :attribute должна быть дата до или быть такой же как :date.',
    'between'              => [
    ...
    'boolean'              => 'Поле :attribute должно иметь значение правда или нет.',
...
',
    ...
    'gt'                   => [
        'numeric' => 'Размер файла в поле :attribute должен быть больше :value Килобайт.',
